...
var chatUI = (function (container) {
  ...
  module.input.append('div').attr('id', 'cb-input-container').append('input').attr('type', 'text').attr('id','chat_input');
  module.input.append('button').attr('id','open_markdown').text('M');
  module.input.append('img').attr('src','/images/emoticon.png').attr('id','chat_emoticon');
  module.input.append('img').attr('src','/images/send.png').attr('id','chat_send');
